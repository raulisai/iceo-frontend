...
export default function DockMenu() {
  ...
  const dockItems = [
    ...
    { label: "Agentes", icon: "👾", description: "Ver y controlar agentes autónomos", color: "#448763", href: "/agentes" },
    { label: "Tasks", icon: "⚙️", description: "Administrar tareas y proyectos en curso", color: "#448763", href: "/tasks" },
